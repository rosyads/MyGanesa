...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_guardians);
    ...
    void init(){
        ...
        findViewById(R.id.btnJadwal).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ProfileActivity.this, TampilJadwalActivity.class);
        ...
        findViewById(R.id.btnHistoryAbsen).setOnClickListener(v -> {
            Intent intent = new Intent(ProfileActivity.this, HistoryAbsenActivity.class);
            startActivity(intent);
        });
...
//        });
        ...
        refresh = () -> {
            UserRefresh userRefresh = new UserRefresh(user.getUsername());
            userRefresh.execute();
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (!obj.getBoolean("error")) {
                    ...
                    if(userJson.getString("role").equals("100")){
                        ...
                        PrefManager.getInstance(getApplicationContext()).setUserLogin(student,"100");
